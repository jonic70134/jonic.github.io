(function () {
    ...
    _proto.initDOM = function () {
        ...
        var canvas = createCanvas(this.options.width - 2, this.options.height); // 畫布
        var block = canvas.cloneNode(true); // 滑動區塊
    ...
    _proto.initImg = function () {
        ...
        var L = this.options.sliderL + this.options.sliderR * 2 + 3; // 滑動區塊實際邊長
        ...
        img.setSrc = function () {
            ...
            if (isIE) { // IE無法通過img.crossOrigin跨域，使用ajax抓到圖片blob後轉為dataURL顯示
                var xhr = new XMLHttpRequest();
                xhr.onloadend = function (e) {
                    var file = new FileReader(); // FileReader僅支持IE10+
