...
enchant.nineleap = { assets: ['./images/start1.png', './images/end.png'] };
...
enchant.nineleap.Game = enchant.Class.create(enchant.Game, {
    ...
    initialize: function(width, height) {
        ...
        this.addEventListener('load', function() {
            ...
            this.startScene.image = this.assets['./images/start1.png'];
    ...
    start: function() {
        ...
        if (location.hostname == 'game_end.html') {
            var submit = function() {
                var id = location.pathname.match(/^\/games\/(\d+)/)[1]; 
                location.replace([
                    'game_end.html', id, '/result',
