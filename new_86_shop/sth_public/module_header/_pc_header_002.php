...
<header class="site-header">
    <div class="container">
        ...
        <div class="cart-btn">
            <a href="#" target="_blank" class="line_icon"></a>
            <a href="#" target="_blank" class="instagram_icon"></a>
            <a href="#" target="_blank" class="youtube_icon"></a>
            <a href="#" target="_blank" class="blogger_icon"></a>
            <a href="#" target="_blank" class="fb_icon"></a>
        </div>
        
        <ul class="site-news">
            <li>雙北5h (試營運)<br>全台24h到貨<a href="#">(說明)</a></li>
        </ul>
    </div>
</header>