        ...
        <div itemscope itemtype="http://data-vocabulary.org/Product" class="item">
                <a href="item.php">
                    ...
                    <div class="info">
                        ...
                        <button href='../module_component/_site_fancybox_all.php #fancybox-call-best-price' class="bird-block call fancybox fancybox.ajax fee-c">省錢通知我</button>
                    </div>
                </a>
            </div>
            <div itemscope itemtype="http://data-vocabulary.org/Product" class="item">
