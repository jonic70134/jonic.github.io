<div class="site-float-bar">
    <div class="container">
    	<div class="float-name">ASUS MeMO Pad ME181C Intet Atom Z3745 / 16GB</div>
        <div class="button large btn-addcart">加入購物車</div>
        <div class="float-price">
            <span class="currency">NT$</span>
            <span itemprop="price" class="price">88,888,888</span>
        </div>
        <div class="r-item-color">
