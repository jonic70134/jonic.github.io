<div class="item-list-four">
    <div class="container">
        <div class="items">
            <?php foreach ($category_items as $key => $value){ ?>
            <figure itemscope itemtype="http://data-vocabulary.org/Product" class="item is-border-none">
                    ...
                    <div class="buy-actions">
                        ...
                        <?php switch ($value['type']) {//按鈕型態
                            ...
                            case 'btn-to-sale':
                                ...
                                break;
                            case 'btn-select':
                                echo '<a href="../module_component/_site_fancybox_rwd.php?siteName=' . $siteName . '#item_main" class="button large btn-select fancybox fancybox.iframe">'.$btn['btn-select'].'</a>';
                                break;
                            case 'btn-addcart':
                        ...
                        <!-- <?php if($items[$pid]['type']=="btn-preorder" || $items[$pid]['type']=="btn-addcart" || $items[$pid]['type']=="btn-discount" || $items[$pid]['type']==""){?> -->
                        <div class="highlight">
