<div class="pc_left_009">
   <div itemscope itemtype="http://data-vocabulary.org/Product" class="item">
        ...
        <div>
            ...
            <a href="#" itemprop="offerurl" class="feature">賣點賣點賣點賣點賣點賣點賣點賣點賣點賣點賣點</a>
            <div class="buy">
                <span class="currency">特價$</span><span itemprop="price" class="price">99999</span>
            </div>
        </div>
        <a href="#" class="more"></a>
    </div>
