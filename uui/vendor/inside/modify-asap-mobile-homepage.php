...
<div id="wrapper">
  ...
  <ul class="breadcrumb"><li><a href="/">首頁</a><span class="divider"> &gt; </span></li> <li class="link">網站佈置<span class="divider"> &gt; </span></li> <li class="active">手機版首頁佈置</li></ul>
</div>
<dl class="modify-tabs">
  <dd><a href="modify-asap-homepage.php">電腦版</a></dd>
  <dd><a href="modify-asap-mobile-homepage.php" class="active">手機版</a></dd>
</dl>
<div class="modify-content">
  ...
  <div class="modify-detail" style="width:500px;">
    <!-- template4: mobile -->
    <div class="modify-block template-4">
      <!-- header -->
