...
<div class="modify-content">
  <h1 class="title"><i class="fa fa-pencil"></i>文字廣告設定</h1>
  <p class="modify-infr">文字編輯，最多可上15則，您已設定5組，尚餘0組。</p>
  <div class="modify-form">
	...
	<div class="form-element edit-nav clearfix">
		<dl class="edit-nav-content">
			<dd><label>文字 </label><input type="text" size="20" placeholder="頁面上的廣告文字"></dd>
