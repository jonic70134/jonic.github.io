...
<div class="modify-content">
  <h1 class="title"><i class="fa fa-pencil"></i>限時特賣區設定</h1>
  <p class="modify-infr">可上傳檔案JPG / JPEG / GIF / PNG檔，尺寸限制200*320px / 500kB以內。<br>本區最多可上5則廣告，您已設定4組，尚餘1組。</p>
  	...
  	<section class="edit-custom">	  	
	  	<div class="form-element edit-ad clearfix">
			<div class="edit-ad-preview">
				...
				<div class="edit-ad-img"><img src="http://placehold.it/200x320/f1f1f1/666666"></div>
			</div>
