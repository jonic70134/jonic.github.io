...
<div id="wrapper" class="full-page">
	...
	<div id="container">
	  <header id="header" class="clearfix">
          <div class="logo">館頁佈置-手機平板館</div>
        </header>
<div class="modify-content">
  <div class="modify-detail">
    <dl class="catagory-function">
      <dd>上層選單：ASAP</dd>
      <dd>選單名稱：<span class="catagory-name">家電、視聽</span></dd>
      <dd>本區色系：
        <dl class="catagory-theme">
          <dd>
            <input type="radio" id="radio_color1" name="radio_color" checked>
            <label for="radio_color1" style="background:#e00517;"></label>
          </dd>
          <dd>
            <input type="radio" id="radio_color2" name="radio_color">
            <label for="radio_color2" style="background:#c15797;"></label>
          </dd>
          <dd>
            <input type="radio" id="radio_color3" name="radio_color">
            <label for="radio_color3" style="background:#90bf4f;"></label>
          </dd>
          <dd>
            <input type="radio" id="radio_color4" name="radio_color">
            <label for="radio_color4" style="background:#00b6f9;"></label>
          </dd>
          <dd>
            <input type="radio" id="radio_color5" name="radio_color">
            <label for="radio_color5" style="background:#ff9a23;"></label>
          </dd>
        </dl>
      </dd>
    </dl>
  ...
  <div class="modify-button">
    <button class="btn-cancel"><i class="fa fa-times"></i>取消並關閉</button>
  ...
  <div class="modify-detail">
    ...
    <div class="modify-block template-2">
      ...
      <section class="template-right-col">
        <!-- ad5 -->
        <section class="template-row t-ad t-ad5">
        ...
        <!-- products -->
        <section class="template-row t-auto-products">
          <div class="t-large-text">This area doesn't need to edit</div>
