...
<section class="template-content">
  <div class="add-product-detail">
    <dl class="form-element add-product-detail-form">
      <dt class="form-label"><span class="highlight">*</span>&nbsp;商品名稱&nbsp;<a class="fa fa-question-circle link-question go-popup" data-width="750" data-href="popup/product-edit-name-infr.php" title="說明"></a></dt>
      <dd class="form-content">
        有人受上了了市啡番知什能啦議醉拚又少將失空本了他害爸他環疲雙&nbsp;&nbsp;<a href="add-product-vendor.php" class="link-tiny">修改</a>
      </dd>
      ...
      <div class="product-right-bloc">
        ...
        <dd class="form-content">
          ...
          <a class="fa fa-question-circle link-question go-popup" data-width="750" data-href="popup/product-edit-sell-name-infr.php" title="說明"></a>
        </dd>
        ...
        <dt class="form-label"></dt>
        <dd class="form-content tight">
          <a class="link-tiny go-popup" data-width="600" data-href="popup/product-edit-color.php" data-with-close="false"><i class="fa fa-plus"></i>&nbsp;顏色</a>&nbsp;&nbsp;&nbsp;&nbsp;
          <a class="link-tiny go-popup" data-width="400" data-href="popup/product-edit-size.php" data-with-close="false"><i class="fa fa-plus"></i>&nbsp;尺寸</a>&nbsp;&nbsp;&nbsp;&nbsp;
          <a class="link-tiny go-popup" data-width="600" data-href="popup/product-edit-color.php" data-with-close="false">編輯顏色/尺寸</a>
        </dd>
        <dt class="form-label"></dt>
        <dd class="form-content">
      ...
      <dt class="form-label-full">
        ...
        <button class="btn-transparent go-popup" data-width="500" data-href="popup/product-edit-video.php"><i class="fa fa-youtube-play"></i>&nbsp;新增影片</button>
      </dt>
      ...
      <dt class="form-label-full">
        商品規格&nbsp;<a class="fa fa-question-circle link-question go-popup" data-width="500" data-href="popup/product-edit-spec-infr.php" title="說明"></a>&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="btn-transparent"><i class="fa fa-picture-o"></i>&nbsp;新增圖<input type="file" class="input-img-file" accept="image/*"></span>
      </dt>
      <dd class="product-editor">
      ...
      <dt class="form-label-full">商品標準配備&nbsp;<a class="fa fa-question-circle link-question go-popup" data-width="500" data-href="popup/product-edit-equip-infr.php" title="說明"></a></dt>
      <dd class="product-editor">
    ...
    <div class="template-button">
      <button class="btn-cancel" onclick="location.href='add-product-vendor.php'"><i class="fa fa-caret-left"></i>上一步</button>
      <button class="btn-submit" onclick="location.href='add-product-upload.php'">下一步&nbsp;&nbsp;<i class="fa fa-caret-right"></i></button>
    </div>
  </div>
</section>
    </div>
