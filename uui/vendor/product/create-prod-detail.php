  ...
  <div class="add-product clearfix">
    ...
    <div class="prod-edit-line clearfix">
      ...
      <div class="prod-price-edit">
        <table class="prod-price-edit-table create-prod-form-list template-table form-element">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td><input type="text" class="input-exlarge input-product-name" size="8" value="690"></td>
              <td>
                  <input type="radio" name="price_radio1" id="1" checked="checked"> 進貨價計<input type="number" value="634" size="5"/><br/><br/>
                  <input type="radio" name="price_radio1" id="2"> 以售價抽<input type="number" value="" size="5"/>％換算
              </td>
              <td>10%</td>
              <td>$69</td>
            </tr>
    ...
    <div class="prod-edit edit-pic template-table clearfix ">
      ...
      <h2 class="sub-title">本商品其它規格資訊</h2>
        ...
        <div class="build-popup-colorsize-addtable clearfix" style="display:none;">
          <table class="build-popup-list build-popup-colorsize-addtable template-table form-element">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                  ...
                  <td><input type="text" value="" size="5"></td>
                  <td><input type="number" name="" id="" value="690"/><br/><br/><br/><br/><label for="chk_price1"><input type="checkbox" name="" id="chk_price1"/>以下全同</label></td>
                  <td><input type="radio" name="price_radio1" id="1">進貨價<input type="number" value="634"/><br/><br/><input type="radio" name="price_radio1" id="2">售價抽<input type="number"  value=""/>％換算<br/><br/><label for="chk_price2"><input type="checkbox" name="" id="chk_price2"/>以下全同</label></td>
