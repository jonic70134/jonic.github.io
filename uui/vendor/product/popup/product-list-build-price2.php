...
<div class="popup-content">
  <h1 class="title"><i class="fa fa-file-text-o"></i>變更預設成本</h1>
  ...
  <table class="build-popup-list template-table form-element ">
    <thead>
      <tr>
        <th colspan="4">目前</th>
        <th class="col-green" colspan="4">變更後</th>
      </tr>
      <tr>
        <th class="col-yellow">預設售價</th>
        <th class="col-yellow">預設成本</th>
        <th class="col-yellow">毛利率</th>
        <th class="col-yellow">毛額</th>
        <th class="col-yellow">預設售價</th>
        <th class="col-yellow">預設成本</th>
        <th class="col-yellow">毛利率</th>
        <th class="col-yellow">毛額</th>
    ...
    <tbody>
      <tr>
        ...
        <td>$690</td>
        <td>
            <input type="radio" name="price_radio1" id="1" checked="checked"> 進貨價<input type="number" class="input-price" value="634" size="5"/><br/><br/>
  ...
  <div class="template-button">
    ...
    <button class="btn-action" onclick="reOpenPopup(850,'popup/product-list-build-price2-sub.php');">下一步</button>
  </div>
</div>
