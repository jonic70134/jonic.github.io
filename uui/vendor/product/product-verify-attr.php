...
<dl class="template-tabs">
  <dd><a href="product-verify.php">分類</a></dd>
  <dd><a href="product-verify-attr.php" class="active">屬性</a></dd>
</dl>
        ...
        <table class="cloud-product-table template-table scroll-content">
          ...
          <tbody>
            <tr>
              ...
              <td>M</td>
              <td>馬克杯</td>
              <td><div class="table-breadcrumb">品牌="SONY"；顏色="黑色"；容量="2L"；</div> <a class="go-popup" data-href="popup/product-verify-attr-popup.php" data-width="1000">詳/修改</a></td>
