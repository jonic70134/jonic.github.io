...
<div id="wrapper">
    ...
    <div id="container">
      ...
      <div class="form-element search-filter">
        <label class="label-search"><input type="text" size="50" placeholder="商品名稱/商品ID/賣場ID/"></label>
        <div class="select-group">
          ...
          <label class="label-search">PM<select name="" id="" class="select-search"><option value="">全部</option><option value="">select1</option><option value="">select2</option></select></label><br/>

         <label class="label-search">廠商<input type="text" size="30" placeholder="廠商名稱/廠商ID"></label>
          <label class="label-search">是否賣海外<select name="" id="" class="select-search"><option value="">全部</option><option value="">select1</option><option value="">select2</option></select></label>
        ...
        <div class="template-function template-button">
          <button class="btn-action" onclick="alert('審核狀態更新成功!');">審核</button>
        </div>
              ...
              for ($x = 0; $x <= 9; $x++) {
                  echo '
                    <tr>
                      ...
                      <td><input type="text" value="毛利太低"/></td>
                      <td>已報名待審核</td>
                      <td>麥可</td>
                      ...
                      <td><span class="highlight">6000</span><br/>5800</td>
