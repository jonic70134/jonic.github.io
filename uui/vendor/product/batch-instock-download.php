...
<div id="wrapper">
  ...
  <ul class="breadcrumb"><li><a href="../index.php">首頁</a><span class="divider"> &gt; </span></li> <li class="link">商品管理<span class="divider"> &gt; </span></li> <li><a href="batch-instock.html">批次修改可賣量</a><span class="divider"> &gt; </span></li> <li class="active">匯出全部上架商品</li></ul>
</div>
  ...
  <dl class="form-element import-form">
    <dd>
      <div class="template-button">
        <button class="btn-action"><i class="fa fa-download"></i>匯出平台全部上架商品</button>
      </div>
      <br><br>
      <label class="form-element-name">其他取得檔案方式：</label>
      <a href="batch-instock-filter.php">篩選商品再匯出<i class="fa fa-external-link"></i></a>、<a href="">下載範例檔案</a>自行編輯
      <br><br>
      <label class="form-element-name">已經有檔案：</label>
      <a href="batch-instock.php">匯入修改資料進行修改<i class="fa fa-external-link"></i></a>
    </dd>
  </dl>
</section>
    </div>
