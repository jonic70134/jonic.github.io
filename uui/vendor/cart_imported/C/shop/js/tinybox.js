...
TINY.box=function(){
    ...
    return{
        show:function(o){
            /*
                增加 maskclickhide、esc 預設值 add@2014-01-24 by Duncan
                maskclickhide → 是否點擊mask處 hide box
                esc → 是否按下esc hide box
             */
            v={
                opacity:70,
                close:1,
            ...
            if(!p){
                ...
                // 是否點擊mask處 HideBox add@2014-01-24 by Duncan
                if(v.maskclickhide == true)
                {
                    m.onclick = TINY.box.hide;
                }

                // 是否點擊關閉按鈕 HideBox add@2014-04-22 by Alan Tseng
                if(v.closebtn == true)
                {
            ...
            if(v.autohide){
                ...
                {
                // 是否按下esc HideBox add@2014-01-24 by Duncan
                if(v.esc == true)
                {
        ...
        fill:function(c,u,k,a,w,h){
            if(u){
                if(v.image){
                    ...
                    this.psh('<iframe src="'+v.iframe+'" width="'+v.width+'" frameborder="0" height="'+v.height+'" id="tinyeditoriframeid"></iframe>',a,w,h)
                }else{
