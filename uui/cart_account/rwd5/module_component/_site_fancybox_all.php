...
<?php //適用商品名稱?>
<div id="fancybox-discount-product" class="f-order fancybox-discount-product">
    <h1 class="title">活動名稱：ASUS zenphone新機現折500元、現折500元</h1>
    <div class="block">
        <h3>折價券號碼：XGS205C123</h3>
        <p>適用商品名稱</p>
        <ul>
                <li>Metal-Slim Asus ZenFone Selfie(ZD551KL)</li>
                <li>ASUS ZenFone Selfie 5.5 吋 FHD LTE 手機 (ZD551KL 3G/16G) - 粉藍</li>
                <li>Metal-Slim Asus ZenFone Selfie(ZD551KL)</li>
                <li>ASUS ZenFone Selfie 5.5 吋 FHD LTE 手機 (ZD551KL 3G/16G) - 粉藍</li>
                <li>Metal-Slim Asus ZenFone Selfie(ZD551KL)</li>
                <li>ASUS ZenFone Selfie 5.5 吋 FHD LTE 手機 (ZD551KL 3G/16G) - 粉藍</li>
...
<?php //使用說明?>
<div id="fancybox-discount-descript" class="f-order fancybox-discount-descript">
    <h1 class="title">ASUS zenphone新機現折500元、現折500元</h1>
    <div class="block">
        <p>購買全系列ASUS ZENPHONE 手機(不含週邊)，立即可折價$500元。</p>
            <ul>
                <li>領取折價券的日期：2016.01.01</li>
                <li>折價券使用起始日：2016.01.05</li>
                <li>結束日：<span>2016.01.30</span></li>
            </ul>
            <div class="actions">
                <a title="Close" href="javascript:void(0);" onclick="$.fancybox.close()" class="button large gray btn-close">朕知道了</a>
            </div>
        </div>
    </div>
</div>
...
<?php //活動說明?>
<div id="fancybox-recommend-friend" class="f-order fancybox-order-event">
    <h1 class="title">推薦好朋友</h1>
    <div class="block">
        <h3>推薦好朋友-成功</h3>
        <div class="actions" style="width: 305px;">
            <a title="再推薦好友" href="javascript:void(0);" onclick="$.fancybox.close()" class="button large light-blue">再推薦好友</a>  
            <a title="回ASAP首頁" href="http://www.asap.com.tw/" class="button large light-red">回ASAP首頁</a>            
        </div>
    </div>
</div>