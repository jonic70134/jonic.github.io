...
<div id="fancybox-order-invoice" class="f-order fancybox-order-invoice">
    ...
    <div class="block">
        ...
        <div class="line">
            ...
            <p>( 發票電子檔為副本僅供參考，不可直接兌獎，若中獎會主動掛號寄出 )</p>
        </div>
        <div class="line">
...
<div id="fancybox-order-shipping" class="f-order fancybox-order-shipping">
    ...
    <div class="block">        
        <div class="line">
            ...
            <ul class="order-item">
                <li>01</li>
                <li><h3>PQI 勁永 U822V 16G USB3.0 旋轉隨身碟 - 紫羅蘭色轉隨身轉隨身轉隨身轉隨身</h3></li>
                <li>1件</li>
            </ul>
    ...
    <div class="block">
        <div class="line">
            <dl>
                ...
                <dd><input type="text" placeholder="收貨人名子" id="input_recipient" value=""></dd>
            </dl>
            <dl>
            ...
            <dl class="o-address">
                ...
                <dd>
                    <input type="text" placeholder="詳細地址" value="">                    
                </dd>
            </dl>
        </div>
