<div class="account_001">
    <div class="container">        
        <nav class="account-menu">            
            ...
            <a href="../module_component/_site_fancybox_all.php #fancybox-invoice-winning" class="fancybox fancybox.ajax highlight-menu"><i class="fa fa-pencil-square-o"></i><p>填中獎發票地址</p></a>
        </nav>
    </div>
</div>