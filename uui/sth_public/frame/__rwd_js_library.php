...
<?php 
if($siteName=='sth_lulu'){
        echo '<script src="../c/js/common/lulu_actions.js"></script>';
    }else{
        echo '<script src="../c/js/common/rwd_actions.js"></script>';
    }
?>
...
<script src="../c/js/common/rwd_index.js"></script>
