...
<body>
    ...
    <div class="site-body">
        ...
        <article class="site-main">
            <?php include "../module_index/_rwd_index_020.php";?>
            <?php include "../module_index/_rwd_index_021.php";?>
            <?php include "../module_index/_rwd_index_022.php";?>
            <?php include "../module_index/_rwd_index_023.php";?>
        </article>
