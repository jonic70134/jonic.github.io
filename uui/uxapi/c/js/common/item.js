...
(function($){
    //單品頁主圖
    var mySwiper = new Swiper('.item-silder-001',{
...
//        }
    ...
    var swiper_carousel = new Swiper('.item-silder-002', {
        slidesPerView: 5,
        slidesPerGroup:5,
        speed: 500,
        loop: true,
    ...
    var swiper_carousel_2 = new Swiper('.item-silder-003', {
        slidesPerView: 5,
        slidesPerGroup:5,
        speed: 500,
        loop: true,
    ...
    var swiper_carousel_3 = new Swiper('.item-silder-004', {
        slidesPerView: 5,
        slidesPerGroup:5,
        speed: 500,
        loop: true,
